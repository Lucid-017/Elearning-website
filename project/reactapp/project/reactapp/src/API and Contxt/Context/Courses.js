...
export const CoursesProvider = ({children})=>{
    ...
    const value = useMemo(()=>( {getTopics,getYear,getGradeCourse,getQuiz,timeFormat,loading,setLoading,error,setError,gradeSelected,setGradeSelected}),[loading,error])
    return(
